cask "dracula-colorslurp" do
  ...
  url "https://#{repo}/archive/refs/heads/#{branch}.tar.gz", verified: repo
  ...
  caveats "You must manually delete the #{tokens.first.capitalize} palette inside #{app_name} to uninstall #{token}."
end
